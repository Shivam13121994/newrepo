...
from rest_framework.authentication import BasicAuthentication  # for basic authentication
from rest_framework.permissions import IsAuthenticated, AllowAny, IsAdminUser         # for permissions

class StudentModelViewSet(viewsets.ModelViewSet):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
    authentication_classes = [BasicAuthentication]   # for basic Authentication with username password
