...
class StudentModelViewSet(viewsets.ModelViewSet):
    ...
    #permission_classes = [IsAdminUser]  # isStaff = True then that user can get that Api
    #permission_classes = [AllowAny]
    #permission_classes = [IsAuthenticatedOrReadOnly]  # if authenticated then write rights else only read 
    #permission_classes = [DjangoModelPermissions]   # unauthenticated user cannot have read permissions
    permission_classes = [DjangoModelPermissionsOrAnonReadOnly]  # unauthenticated users have read permissions
